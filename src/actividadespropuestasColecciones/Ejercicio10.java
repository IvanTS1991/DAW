...
public class Ejercicio10 {
	...
	public static void main(String[] args) {
		...
		Map<Integer,String> equipo = new HashMap<Integer, String>();
		...
		// Ordenando el Map por Clave de menor a mayor
		
		equipo.entrySet().stream().sorted(Map.Entry.comparingByKey()).forEach(System.out::println );
